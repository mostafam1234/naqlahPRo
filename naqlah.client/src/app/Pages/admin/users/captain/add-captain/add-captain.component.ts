...
export class AddCaptainComponent implements OnInit, OnDestroy {
    ...
    this.subs.sink = this.deliveryManClient.addDeliveryMan(body).subscribe({
      next: () => {
        ...
        this.toasterService.success(
          ...
          this.translate.instant('ADMIN.PAGES.CAPTAIN_FORM.TOAST.ADD_SUCCESS_MSG')
        );
      ...
      error: (error) => {
        ...
        this.toasterService.error(
          ...
          error?.errorMessage || this.translate.instant('ADMIN.PAGES.CAPTAIN_FORM.TOAST.ADD_ERROR_MSG')
        );
      }
    });
  }
  ...
  onCancel(): void {
    ...
    this.subs.sink = this.confirmationDialog.confirm({
      ...
      message: this.translate.instant('ADMIN.PAGES.CAPTAIN_FORM.CANCEL_DIALOG.MESSAGE_ADD'),
