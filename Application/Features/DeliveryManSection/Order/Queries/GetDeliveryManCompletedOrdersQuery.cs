...
{
    public sealed record GetDeliveryManCompletedOrdersQuery : IRequest<Result<List<AcceptedOrder>>>
    {
        public int PageNumber { get; set; }
        public int PageSize { get; set; }
        private class GetDeliveryManCompletedOrdersQueryHandler : IRequestHandler<GetDeliveryManCompletedOrdersQuery, Result<List<AcceptedOrder>>>
        {
            ...
            public GetDeliveryManCompletedOrdersQueryHandler(INaqlahContext context,
            ...
            public async Task<Result<List<AcceptedOrder>>> Handle(GetDeliveryManCompletedOrdersQuery request, CancellationToken cancellationToken)
            {
                ...
                var orders = await context.Orders
                                        ...
                                        .Where(x => x.DeliveryManId == deliveryMan.Id && x.OrderStatus == Domain.Enums.OrderStatus.Completed)
