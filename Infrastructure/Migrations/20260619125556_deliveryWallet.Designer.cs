...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260619125556_deliveryWallet")]
    partial class deliveryWallet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.AdditionalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NA_AdditionalService", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.AuditLogDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Complain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NA_Complains", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.CustomerNotification", b =>
                {
                    ...
                    b.ToTable("NA_CustomerNotification", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.DeliveryManWalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NA_DeliveryManWalletTransaction", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.DiscountCode", b =>
                {
                    ...
                    b.ToTable("NA_DiscountCode", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Order", b =>
                {
                    ...
                    b.Property<bool>("ClientApprovedPickup")
                        .HasColumnType("bit");
                    ...
                    b.Property<double>("DistanceInKiloMeter")
                        .HasColumnType("float");

                    b.Property<bool>("DriverConfirmedGoingToPickup")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("ExpectedPickUpTime")
                        .HasColumnType("datetime2");

                    b.Property<double>("ExpectedTimeMinutes")
                        .HasColumnType("float");

                    b.Property<string>("HashedLocation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.OrderAdditionalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NA_OrderAdditionalServices", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.OrderRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NA_OrderRating", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Suggestion", b =>
                {
                    ...
                    b.ToTable("NA_Suggestions", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.AuditLogDetail", b =>
                {
                    b.HasOne("Domain.Models.AuditLog", "AuditLog")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("Domain.Models.OrderAdditionalService", b =>
                {
                    b.HasOne("Domain.Models.AdditionalService", "AdditionalService")
                        .WithMany()
